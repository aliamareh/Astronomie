...
class ConstellationRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(Constellation $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(Constellation $entity, bool $flush = true): void
    {
    ...
    // /**
    //  * @return Constellation[] Returns an array of Constellation objects
    //  */
    /*
    ...
    */
    ...
    /*
    public function findOneBySomeField($value): ?Constellation
    {
        return $this->createQueryBuilder('c')
            ->andWhere('c.exampleField = :val')
            ->setParameter('val', $value)
